    ...
    <nav class="main-nav navbar navbar-expand-lg hover-navbar dark-to-light fixed-top navbar-dark">
      <div class="container">
        <a class="navbar-brand main-logo" href="#">
          <img class="logo-light" src="./src/images/png/nosso_corre.png" alt="LOGO">
          <img class="logo-dark" src="./src/images/png/nosso_corre.png" alt="LOGO">
        </a>
              ...
              <div class="dropdown-menu dropdown-menu-md dropdown-menu-lg-center p-4" aria-labelledby="navbarmd">
                <div class="list-group list-group-flush">
                  <a class="list-group-item dropdown-item bg-tansparent d-flex align-item-center" href="">
                    ...
                    <div class="align-self-center text-primary">
                      <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' viewBox='0 0 512 512'>
                        <path stroke="currentColor" d='M416,221.25V416a48,48,0,0,1-48,48H144a48,48,0,0,1-48-48V96a48,48,0,0,1,48-48h98.75a32,32,0,0,1,22.62,9.37L406.63,198.63A32,32,0,0,1,416,221.25Z' style='fill:none;stroke-linejoin:round;stroke-width:32px' />
                  ...
                  <a class="list-group-item dropdown-item bg-tansparent d-flex align-item-center" href="#">
                    ...
                    <div class="align-self-center text-primary">
                      <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' viewBox='0 0 512 512'>
                        <polyline stroke="currentColor" points='160 368 32 256 160 144' style='fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px' />
                        <polyline stroke="currentColor" points='352 368 480 256 352 144' style='fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px' />
                        <line stroke="currentColor" x1='304' y1='96' x2='208' y2='416' style='fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px' />
                      </svg>
                    </div>
            ...
            <ol class="process-vertical ps-0" data-aos="flip-up">
              ...
              <li class="process-vertical-item">
                <div class="process-vertical-icon">
                  <div class="process-vertical-icon-bg me-auto rounded-circle p-2">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="2rem" height="2rem" viewBox="5.006 23.881 199.987 95.238">
              ...
              <li class="process-vertical-item">
                <div class="process-vertical-icon">
                  <div class="process-vertical-icon-bg me-auto rounded-circle p-2">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="1.5rem" height="1.5rem" fill="currentColor" viewBox="0 0 512 512">
